        ...
        <div className="px-6 mb-6">
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <ChevronDown className={`w-4 h-4 text-stripe-slate transition-transform duration-200 ${isBranchDropdownOpen ? 'rotate-180' : ''}`} />
            </button>

            {isBranchDropdownOpen && (
              <div className="absolute left-0 right-0 mt-2 py-1.5 bg-white border border-gray-100 rounded-xl shadow-stripe-lg z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                <button
                  onClick={() => {
                    onBranchChange('all');
                    setIsBranchDropdownOpen(false);
