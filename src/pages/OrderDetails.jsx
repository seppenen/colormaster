                  ...
                  <div className="space-y-4 animate-in fade-in duration-200">
                    <div className="space-y-2 relative">
                      ...
                      {priceFormData.includeAlv && (
                        <span className="absolute right-3 top-[38px] text-[10px] font-bold text-green-600 uppercase bg-white pl-1">
                          sis. alv
                        </span>
                      )}
                    </div>
                    <div className="flex items-center">
                      <button
                        type="button"
                        onClick={() => {
                          const currentPrice = parseFloat(priceFormData.price);
                          if (!isNaN(currentPrice)) {
                            const newPrice = (currentPrice * 1.255).toFixed(2);
                            setPriceFormData(prev => ({ ...prev, price: newPrice, includeAlv: true }));
                          }
                        }}
                      ...
                      {priceFormData.includeAlv && (
                        <button
                          type="button"
                          onClick={() => setPriceFormData(prev => ({ ...prev, includeAlv: false }))}
